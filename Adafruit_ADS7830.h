...
typedef enum {
  POWER_DOWN_BETWEEN_CONVERSIONS = 0x00, ///< Power Down Between A/D Converter Conversions
  INTERNAL_REF_OFF_ADC_ON = 0x01, ///< Internal Reference OFF and A/D Converter ON
  INTERNAL_REF_ON_ADC_OFF = 0x02, ///< Internal Reference ON and A/D Converter OFF
